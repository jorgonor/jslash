...
describe('Sprite',function()
{
  ...
  it("should return the image sizes on imageRect and canvasRect methods",function() {
    ...
    var s = new core.Sprite(fkImg, new core.Point(1,100));
    var rect = new core.Rectangle(0,0,100,200);
    var csRect = new core.Rectangle(1,100,100,200);
  ...
  it("should be able to set the image subrect",function() {
    var s = new core.Sprite(fkImg);
    var rect = new core.Rectangle(10,10,30,30);
    s.imageRect(rect);
    expect(s.imageRect()).toEqual(rect);
  });
  ...
  it("should be able to scale the sprite",function() {
    ...
    var rect = new core.Rectangle(imgRect.x,imgRect.y, imgRect.width*2,imgRect.height*2);
