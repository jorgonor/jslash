...
(a[c]=b[c])};jslash.times=function(a,b){for(var c=0;c<a;c++)b()};jslash.prefetchImg=function(a){if(!f(this.images))this.images={};typeof a=="string"&&(a=[a]);var b=this;jslash.each(a,function(a,e){w++;var d=new Image;d.src=e;d.addEventListener("load",function(){v++});b.images[e]=d})};jslash.prefetchAudioSources=function(a){typeof a=="string"&&(a=[a]);jslash.each(a,function(a,c){var e=new Audio;e.src=c;w++;e.addEventListener("load",function(){v++},true)})};jslash.properties=function(a){var b=[],c;
