var jslash={};
(function(){function d(a,b){var c=a.prototype.constructor;a.prototype=b;a.prototype.constructor=c}function k(){this.message="This method must be implemented.";this.name="NotImplementedError"}function g(){throw new k;}function l(a,b){a.images=[];jslash.each(b,function(b,c){jslash.prefetchImg(c);a.images.push(jslash.images[c])});var c=setInterval(function(){var b=true;jslash.each(a.images,function(a,c){b=b&&c.complete});if(b)a._ready=true,clearInterval(c)},t)}function n(a,b,c){f(c)||(c=null);for(var e=
[],q=0;q<a;q++){var d=[];e.push(d);for(var h=0;h<b;h++)d.push(c)}return e}function z(a,b){var c=b.map;a.orientation=c.orientation;a.properties=c.properties;a.tileheight=parseFloat(c.tileheight);a.tilewidth=parseFloat(c.tilewidth);a.width=parseFloat(c.width);a.height=parseFloat(c.height);for(var e=[],q=[],d=[],h=0;h<b.images.length;h++){var g=b.images[h],j=b.tilesets[h];d.push({tilesPerWidth:o.div(g.width,j.tilewidth),tileheight:parseFloat(j.tileheight),tilewidth:parseFloat(j.tilewidth)});e.push(g.source);
delete j.name;q.push(j)}l(a,e);a.layers=[];a.obstacles=n(c.height,c.width,false);jslash.each(b.layers,function(b,e){var h=n(c.height,c.width);h.properties=e.properties;if(h.properties&&h.properties.obstacle)h.obstacles=n(c.height,c.width);a.layers.push(h);for(var g=0;g<e.data.length;g++){for(var j=o.div(g,c.width),l=g%c.width,k=e.data[g],u,m=void 0,p=null,r=q.length-1;r>=0;r--)if(u=q[r],u.firstgid<=k){m=r;break}f(m)&&(k-=u.firstgid,p=d[m],r=o.div(k,p.tilesPerWidth)*p.tileheight,p=new jslash.Frame(a.images[m],
new jslash.Rect(k%p.tilesPerWidth*p.tilewidth,r,p.tilewidth,p.tileheight)));h[j][l]=p;h.obstacles&&(h.obstacles[j][l]=p!=null)}})}function f(a){return a!=void 0}function E(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}function A(a){a=document.createElement(a);document.body.appendChild(a);return a}function F(){B||(window.addEventListener("keydown",
function(a){a.keyCode in m&&jslash.each(m[a.keyCode],function(a,c){c()})},true),B=true)}function C(a){var b=[];jslash.each(a,function(a,e){b.push(a+"=");b.push(encodeURIComponent(e));b.push("&")});b.pop();return b.join("")}d(k,Error());jslash.Rectangle=function(a,b,c,e){this.x=a;this.y=b;this.width=c;this.height=e};jslash.Rect=jslash.Rectangle;jslash.Rectangle.prototype.center=function(a,b){var c=(2*this.x+this.width)/2,e=(2*this.y+this.height)/2;if(!f(a)||!f(b))return new jslash.Point(c,e);this.x+=
...
(b++,f(s)||(s=new jslash.Canvas,s._canvas.style.setProperty("display","none","")),c=s);c.fill(jslash.colorkey);for(var e=0,d=0,i=0;i<b;i++){var h=arguments[i],g=h.width(),j=h.height();e<g&&(e=g);d<j&&(d=j);c.draw(h)}this._imgData=a>0?c.context.getImageData(0,0,e,d):null;if(this._imgData!=null){g=this._imgData.width;j=this._imgData.height;for(a=0;a<g;a++)for(c=0;c<j;c++)if(i=b=a*g*4+c*4,(new jslash.Color(this._imgData.data[i++],this._imgData.data[i++],this._imgData[i++],this._imgData[i++])).equals(jslash.colorkey))for(;b<
...
"string"&&(a=JSON.parse(a));if(typeof a!="object")throw Error("the argument should be an string or an object");z(this,a)}};d(jslash.TiledTileset,new jslash.BaseTileset);jslash.TiledTileset.prototype.load=function(a){var b=this;(new jslash.net.Request(a,"GET")).send(function(a){a=JSON.parse(a);z(b,a)})};jslash.TiledTileset.prototype.draw=function(a){a.save();a.globalAlpha=this.alpha;var b=f(this._canvasRect)?this._canvasRect.width:a.canvas.width,c=f(this._canvasRect)?this._canvasRect.height:a.canvas.height,
e=f(this._canvasRect)?this._canvasRect.x:0,d=f(this._canvasRect)?this._canvasRect.y:0,i=this;jslash.each(this.layers,function(f,g){for(var j,k=i.firstrow,l=d;l<c&&k<i.height;l+=i.tileheight,k++){j=i.firstcol;for(var m=e;m<b&&j<i.width;m+=i.tilewidth,j++){var o=g[k][j];if(o){var n=o.rect();a.drawImage(o.image(),n.x,n.y,n.width,n.height,m,l,n.width,n.height)}}}});a.restore()};jslash.TiledTileset.prototype.cellIsObstacle=function(a,b){if(a>=0&&a<this.obstacles.length&&b>=0&&b<this.obstacles[0].length&&
this.obstacles[a][b])return true;var c=false,e=this;jslash.each(this.layers,function(d,i){f(i.obstacles)&&(c=a>=0&&b>=0&&b<e.width&&a<e.height?c||i.obstacles[a][b]:true)});return c};jslash.TiledTileset.prototype.ready=function(a){var b=this,c=setInterval(function(){b._ready&&(a(),clearInterval(c))},t)};jslash.TiledTileset.prototype.putObstacleOn=function(a,b){this.obstacles[a][b]=true};jslash.Animation=function(a,b,c,e){this._boundProp=b;this._boundObj=a;this._time=c;this._transform=e};jslash.Animation.prototype.from=
function(a){this._from=a;return this};jslash.Animation.prototype.to=function(a){this._to=a;return this};jslash.Animation.prototype.start=function(){var a=this;if(f(this._transform))c=setInterval(function(){a._boundObj[a._boundProp]=a._transform(a._boundObj,a._boundObj[a._boundProp])},v),setTimeout(function(){clearInterval(c)},this._time);else{if(!f(this._to)||!f(this._from))throw Error("from and to methods must have been called previously");var b=(this._to-this._from)/(this._time/v);this._boundObj[this._boundProp]=
this._from;var c=setInterval(function(){a._boundObj[a._boundProp]+=b;if(a._boundObj[a._boundProp]>=a._to)a._boundObj[a._boundProp]=a._to,clearInterval(c)},v)}};jslash.Gradient=function(a,b){this.startPoint=a;this.endPoint=b;this._canvasRect=new jslash.Rectangle(a.x,a.y,b.x-a.x,b.y-a.y);this._intermediateColors=[]};jslash.Gradient.prototype.startColor=function(a){this._startColor=a;return this};jslash.Gradient.prototype.endColor=function(a){this._endColor=a;return this};jslash.Gradient.prototype.colorAt=
...
!b(c,a[c]))return false;return true}};jslash.prefetchImg=function(a){if(!f(this.images))this.images={};typeof a=="string"&&(a=[a]);var b=this;jslash.each(a,function(a,e){x++;var d=new Image;d.src=e;d.addEventListener("load",function(){w++});b.images[e]=d})};jslash.prefetchAudioSources=function(a){typeof a=="string"&&(a=[a]);jslash.each(a,function(a,c){var e=new Audio;e.src=c;x++;e.addEventListener("load",function(){w++},true)})};jslash.properties=function(a){var b=[],c;for(c in a)a.hasOwnProperty(c)&&
b.push(c);return b};jslash.isDefined=f;jslash.values=function(a){return this.properties(a).map(function(b){return a[b]})};jslash.sliceImg=function(a,b){for(var c=[],e=b.y;e<a.height;e+=b.height)for(var d=b.x;d<a.width;d+=b.width)c.push(new this.Frame(a,new this.Rectangle(d,e,b.width,b.height)));return c};jslash.ready=function(a){window.addEventListener("load",a,true)};jslash.domReady=function(a){window.addEventListener("DOMContentLoaded",a,true)};jslash.hasAuxiliarCanvas=function(){return f(s)};var o=
{mul:function(a,b){return Math.floor(a*b)},div:function(a,b){return Math.floor(a/b)}};jslash.behaviors={};var H=function(a){var b,c;c=this.position();b=c.x;c=c.y;b+=this.speed.x*a/1E3;c+=this.speed.y*a/1E3;this.position(b,c)},I=function(a){var b=this._boundProperty?this[this._boundProperty]:this,c=a._boundProperty?a[a._boundProperty]:a,b=typeof b!="function"?b:b.apply(this),c=typeof c!="function"?c:c.apply(a);if(a=this.shape.collide(b,c)){if(b.oncollides)b.oncollides(c);if(c.oncollides)c.oncollides(b)}return a},
J=function(a){var b,c,e,d,f;c=this.position();b=c.x;c=c.y;b+=this.speed.x*a/1E3;c+=this.speed.y*a/1E3;a=this.region.x;e=this.region.y;d=a+this.region.width;f=e+this.region.height;b<a&&(b=a);c<e&&(c=e);b>d&&(b=d);c>f&&(c=f);this.position(b,c)};jslash.behaviors.Movable=function(a,b){this.speed={x:a,y:b};this.move=H};jslash.behaviors.Collidable=function(a,b){this.shape=a;this._boundProperty=b;this.collides=I};jslash.behaviors.LimitedMovable=function(a,b,c){this.speed={x:a,y:b};this.region=c;this.move=
J};window.addEventListener("load",function(){loadDispatched=true},true);jslash.net={};jslash.net.Request=function(a,b){this.src=f(a)?a:"";this.method=f(b)?b.toUpperCase():"GET";this._xhr=new XMLHttpRequest;this._sending=false};jslash.net.Request.prototype.send=function(a,b){var c=this;this.method=this.method.toUpperCase();var e=this._xhr,d,g;if(f(b)){if(b instanceof Function)g=b;else throw Error("if second parameter is specified must be a Function");f(a)&&typeof a=="object"&&(d=a)}else g=a;var h=
this.src;f(d)&&this.method=="GET"&&(h+="?"+C(d));e.open(this.method,h,true);e.onreadystatechange=function(){if(e.readyState==4)c._sending=false,g(e.responseText)};h=null;this.method=="POST"&&(e.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),f(d)&&(h=C(d)));e.send(h);this._sending=true};jslash.net.Request.prototype.isSending=function(){return this._sending};jslash.net.post=function(a,b,c){(new jslash.net.Request(a,"POST")).send(b,c)};jslash.net.get=function(a,b,c){(new jslash.net.Request(a,
"GET")).send(b,c)}})();(function(){jslash.shapes={};jslash.shapes.Rectangle=function(d,k,g,l,n){this.x=d;this.y=k;this.width=g;this.height=l;this.color=jslash.isDefined(n)?n:new jslash.Color(0,0,0);this._filled=true};jslash.shapes.Rectangle.prototype.stroke=function(d){this._strokeSize=d;this._filled=false};jslash.shapes.Rectangle.prototype.fill=function(){this._filled=true};jslash.shapes.Rectangle.prototype.draw=function(d){this._filled?(d.fillStyle=this.color.toString(),d.fillRect(this.x,this.y,this.width,this.height)):
(d.strokeStyle=this.color.toString(),d.lineWidth=this._strokeSize,d.strokeRect(this.x,this.y,this.width,this.height))};jslash.shapes.Rectangle.prototype.toSizeable=function(){var d=this;return{width:function(){return d.width},height:function(){return d.height}}};jslash.shapes.Circle=function(d,k,g,l){this.center_x=d;this.center_y=k;this.radius=g;this.color=jslash.isDefined(l)?l:new jslash.Color(0,0,0);this._filled=true};jslash.shapes.Circle.prototype.stroke=function(d){this._strokeSize=d;this._filled=
false};jslash.shapes.Circle.prototype.fill=function(){this._filled=true};jslash.shapes.Circle.prototype.draw=function(d){d.beginPath();d.arc(this.center_x,this.center_y,this.radius,0,2*Math.PI,0);this._filled?(d.fillStyle=this.color.toString(),d.fill()):(d.strokeStyle=this.color.toString(),d.lineWidth=this._strokeSize,d.stroke());d.closePath()};jslash.shapes.Line=function(d,k,g,l){this.from=d;this.to=k;this.color=jslash.isDefined(g)?g:new jslash.Color(0,0,0);this.width=jslash.isDefined(l)?l:1};jslash.shapes.Line.prototype.draw=
