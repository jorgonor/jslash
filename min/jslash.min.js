var jslash={};
(function(){function d(a,b){var c=a.prototype.constructor;a.prototype=b;a.prototype.constructor=c}function j(){this.message="This method must be implemented.";this.name="NotImplementedError"}function h(){throw new j;}function k(a,b){a.images=[];jslash.each(b,function(b,c){jslash.prefetchImg(c);a.images.push(jslash.images[c])});var c=setInterval(function(){var b=true;jslash.each(a.images,function(a,c){b=b&&c.complete});if(b)a._ready=true,clearInterval(c)},t)}function m(a,b,c){f(c)||(c=null);for(var e=
[],q=0;q<a;q++){var g=[];e.push(g);for(var d=0;d<b;d++)g.push(c)}return e}function y(a,b){var c=b.map;a.orientation=c.orientation;a.properties=c.properties;a.tileheight=parseFloat(c.tileheight);a.tilewidth=parseFloat(c.tilewidth);a.width=parseFloat(c.width);a.height=parseFloat(c.height);for(var e=[],q=[],g=[],d=0;d<b.images.length;d++){var n=b.images[d],i=b.tilesets[d];g.push({tilesPerWidth:o.div(n.width,i.tilewidth),tileheight:parseFloat(i.tileheight),tilewidth:parseFloat(i.tilewidth)});e.push(n.source);
delete i.name;q.push(i)}k(a,e);a.layers=[];a.obstacles=m(c.height,c.width,false);jslash.each(b.layers,function(b,e){var d=m(c.height,c.width);d.properties=e.properties;if(d.properties&&d.properties.obstacle)d.obstacles=m(c.height,c.width);a.layers.push(d);for(var i=0;i<e.data.length;i++){for(var n=o.div(i,c.width),h=i%c.width,j=e.data[i],k,l=void 0,p=null,r=q.length-1;r>=0;r--)if(k=q[r],k.firstgid<=j){l=r;break}f(l)&&(j-=k.firstgid,p=g[l],r=o.div(j,p.tilesPerWidth)*p.tileheight,p=new jslash.Frame(a.images[l],
new jslash.Rect(j%p.tilesPerWidth*p.tilewidth,r,p.tilewidth,p.tileheight)));d[n][h]=p;d.obstacles&&(d.obstacles[n][h]=p!=null)}})}function f(a){return a!=void 0}function D(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}function z(a){a=document.createElement(a);document.body.appendChild(a);return a}function E(){A||(window.addEventListener("keydown",
function(a){a.keyCode in l&&jslash.each(l[a.keyCode],function(a,c){c()})},true),A=true)}function B(a){var b=[];jslash.each(a,function(a,e){b.push(a+"=");b.push(encodeURIComponent(e));b.push("&")});b.pop();return b.join("")}d(j,Error());jslash.Rectangle=function(a,b,c,e){this.x=a;this.y=b;this.width=c;this.height=e};jslash.Rect=jslash.Rectangle;jslash.Rectangle.prototype.center=function(a,b){var c=(2*this.x+this.width)/2,e=(2*this.y+this.height)/2;if(!f(a)||!f(b))return new jslash.Point(c,e);this.x+=
...
f(b)?b.x:0,e=f(b)?b.y:0;this._canvasSubrect=new jslash.Rectangle(c,e,a.width,a.height);this._imageSubrect=new jslash.Rectangle(0,0,a.width,a.height)};d(jslash.Sprite,new jslash.BaseSprite);jslash.Sprite.prototype.image=function(){return this._img};jslash.Sprite.prototype.imageRect=function(a){if(!f(a))return this._imageSubrect;this._imageSubrect=a};jslash.Sprite.prototype.canvasRect=function(a){if(!f(a))return this._canvasSubrect;this._canvasSubrect=a};jslash.Sprite.prototype.position=function(a,
b){if(!f(a)||!f(b))return new jslash.Point(this._canvasSubrect.x,this._canvasSubrect.y);this._canvasSubrect.x=a;this._canvasSubrect.y=b};jslash.Frame=function(a,b){this._img=a;this._subrect=b};jslash.Frame.prototype.image=function(){return this._img};jslash.Frame.prototype.rect=function(){return this._subrect};jslash.AnimatedSprite=function(a){jslash.BaseSprite.apply(this);this._frames=a;this._currentFrame=0};d(jslash.AnimatedSprite,new jslash.BaseSprite);jslash.AnimatedSprite.makeRefresh=function(a){f(a)||
(a=10);var b=0;return function(){b==a?(b=0,this.next()):b++}};jslash.AnimatedSprite.prototype.next=function(){this._currentFrame=(this._currentFrame+1)%this._frames.length};jslash.AnimatedSprite.prototype.image=function(){return this._frames[this._currentFrame].image()};jslash.AnimatedSprite.prototype.imageRect=function(){return this._frames[this._currentFrame].rect()};jslash.AnimatedSprite.prototype.canvasRect=function(a){if(!f(a)){if(!f(this._canvasSubrect))this._canvasSubrect=jslash.deepcopy(this._frames[this._currentFrame].rect());
return this._canvasSubrect}this._canvasSubrect=a};jslash.AnimatedSprite.prototype.position=function(a,b){if(!f(a)||!f(b)){var c=this.canvasRect();return new jslash.Point(c.x,c.y)}f(this._canvasSubrect)||this.canvasRect(jslash.deepcopy(this.canvasRect()));this._canvasSubrect.x=a;this._canvasSubrect.y=b};jslash.CompositeSprite=function(){jslash.BaseSprite.apply(this);var a=arguments.length,b=a-1,c;b>0&&arguments[b]instanceof jslash.Canvas?c=arguments[b]:(b++,f(s)||(s=new jslash.Canvas,s._canvas.style.setProperty("display",
"none","")),c=s);c.fill(jslash.colorkey);for(var e=0,d=0,g=0;g<b;g++){var h=arguments[g],n=h.width(),i=h.height();e<n&&(e=n);d<i&&(d=i);c.draw(h)}this._imgData=a>0?c.context.getImageData(0,0,e,d):null;if(this._imgData!=null){n=this._imgData.width;i=this._imgData.height;for(a=0;a<n;a++)for(c=0;c<i;c++)if(g=b=a*n*4+c*4,(new jslash.Color(this._imgData.data[g++],this._imgData.data[g++],this._imgData[g++],this._imgData[g++])).equals(jslash.colorkey))for(;b<g;b++)this._imgData.data[b]=0}this.x=this.y=0};
d(jslash.CompositeSprite,new jslash.BaseSprite);jslash.CompositeSprite.prototype.position=function(a,b){if(!f(a)||!f(b))return new jslash.Point(this.x,this.y);this.x=a;this.y=b};jslash.CompositeSprite.prototype.draw=function(a){a.putImageData(this._imgData,this.x,this.y)};jslash.Text=function(a,b,c){this.text=a||"";this.font="Arial";this.color="black";this.weight="";this.size=12;this.x=f(b)?b:0;this.y=f(c)?c:0};jslash.Text.prototype.draw=function(a){a.save();a.fillStyle=this.color.toString();a.font=
[this.weight,this.size,this.font].join(" ").trim();a.fillText(this.text,this.x,this.y+this.size);a.restore()};jslash.Text.prototype.width=function(a){a=a.context;a.save();a.fillStyle=this.color;a.font=[this.weight,this.size,this.font].join(" ");var b=a.measureText(this.text).width;a.restore();return b};jslash.Text.prototype.height=function(){return this.size};jslash.Audio=function(a){f(a)?a=jslash.byId(a):(a=z("audio"),a.id="audio"+F++);this._audio=a};jslash.Audio.prototype.load=function(a){this._audio.src=
...
e=f(this._canvasRect)?this._canvasRect.x:0,d=f(this._canvasRect)?this._canvasRect.y:0,g=this;jslash.each(this.layers,function(f,h){for(var i,j=g.firstrow,k=d;k<c&&j<g.height;k+=g.tileheight,j++){i=g.firstcol;for(var l=e;l<b&&i<g.width;l+=g.tilewidth,i++){var o=h[j][i];if(o){var m=o.rect();a.drawImage(o.image(),m.x,m.y,m.width,m.height,l,k,m.width,m.height)}}}});a.restore()};jslash.TiledTileset.prototype.cellIsObstacle=function(a,b){if(a>=0&&a<this.obstacles.length&&b>=0&&b<this.obstacles[0].length&&
this.obstacles[a][b])return true;var c=false,e=this;jslash.each(this.layers,function(d,g){f(g.obstacles)&&(c=a>=0&&b>=0&&b<e.width&&a<e.height?c||g.obstacles[a][b]:true)});return c};jslash.TiledTileset.prototype.ready=function(a){var b=this,c=setInterval(function(){b._ready&&(a(),clearInterval(c))},t)};jslash.TiledTileset.prototype.putObstacleOn=function(a,b){this.obstacles[a][b]=true};jslash.Animation=function(a,b,c,e){this._boundProp=b;this._boundObj=a;this._time=c;this._transform=e};jslash.Animation.prototype.from=
function(a){this._from=a;return this};jslash.Animation.prototype.to=function(a){this._to=a;return this};jslash.Animation.prototype.start=function(){var a=this;if(f(this._transform))c=setInterval(function(){a._boundObj[a._boundProp]=a._transform(a._boundObj,a._boundObj[a._boundProp])},u),setTimeout(function(){clearInterval(c)},this._time);else{if(!f(this._to)||!f(this._from))throw Error("from and to methods must have been called previously");var b=(this._to-this._from)/(this._time/u);this._boundObj[this._boundProp]=
this._from;var c=setInterval(function(){a._boundObj[a._boundProp]+=b;if(a._boundObj[a._boundProp]>=a._to)a._boundObj[a._boundProp]=a._to,clearInterval(c)},u)}};jslash.Gradient=function(a,b){this.startPoint=a;this.endPoint=b;this._canvasRect=new jslash.Rectangle(a.x,a.y,b.x-a.x,b.y-a.y);this._intermediateColors=[]};jslash.Gradient.prototype.startColor=function(a){this._startColor=a;return this};jslash.Gradient.prototype.endColor=function(a){this._endColor=a;return this};jslash.Gradient.prototype.colorAt=
...
jslash.start=function(a){function b(a){c.onupdate&&(c.onupdate(a-e),e=a);if(c.onclear)c.onclear();if(c.onrefresh)c.onrefresh();x&&d(b)}var c=this,e=(new Date).getTime(),d=D();if(f(a))this.borders=new jslash.BorderedRectangle(0,0,a.width(),a.height()),this.mix(this.borders,new this.behaviors.Collidable(jslash.BorderedRectangle));x=true;d(b)};jslash.stop=function(){x=false};jslash.addKeyEvent=function(a,b){a in l||(l[a]=[]);l[a].push(b);E()};jslash.deepcopy=function(a){var b=new a.constructor,c;for(c in a)a.hasOwnProperty(c)&&
...
(a[c]=b[c])};jslash.times=function(a,b){for(var c=0;c<a;c++)b()};jslash.prefetchImg=function(a){if(!f(this.images))this.images={};typeof a=="string"&&(a=[a]);var b=this;jslash.each(a,function(a,e){w++;var d=new Image;d.src=e;d.addEventListener("load",function(){v++});b.images[e]=d})};jslash.prefetchAudioSources=function(a){typeof a=="string"&&(a=[a]);jslash.each(a,function(a,c){var d=new Audio;d.src=c;w++;d.addEventListener("load",function(){v++},true)})};jslash.properties=function(a){var b=[],c;
for(c in a)a.hasOwnProperty(c)&&b.push(c);return b};jslash.isDefined=f;jslash.values=function(a){return this.properties(a).map(function(b){return a[b]})};jslash.sliceImg=function(a,b){for(var c=[],d=b.y;d<a.height;d+=b.height)for(var f=b.x;f<a.width;f+=b.width)c.push(new this.Frame(a,new this.Rectangle(f,d,b.width,b.height)));return c};jslash.ready=function(a){window.addEventListener("load",a,true)};jslash.domReady=function(a){window.addEventListener("DOMContentLoaded",a,true)};jslash.hasAuxiliarCanvas=
function(){return f(s)};var o={mul:function(a,b){return Math.floor(a*b)},div:function(a,b){return Math.floor(a/b)}};jslash.behaviors={};var G=function(a){var b,c;c=this.position();b=c.x;c=c.y;b+=this.speed.x*a/1E3;c+=this.speed.y*a/1E3;this.position(b,c)},H=function(a){var b=this._boundProperty?this[this._boundProperty]:this,c=a._boundProperty?a[a._boundProperty]:a,b=typeof b!="function"?b:b.apply(this),c=typeof c!="function"?c:c.apply(a);if(a=this.shape.collide(b,c)){if(b.oncollides)b.oncollides(c);
if(c.oncollides)c.oncollides(b)}return a},I=function(a){var b,c,d,f,g;c=this.position();b=c.x;c=c.y;b+=this.speed.x*a/1E3;c+=this.speed.y*a/1E3;a=this.region.x;d=this.region.y;f=a+this.region.width;g=d+this.region.height;b<a&&(b=a);c<d&&(c=d);b>f&&(b=f);c>g&&(c=g);this.position(b,c)};jslash.behaviors.Movable=function(a,b){this.speed={x:a,y:b};this.move=G};jslash.behaviors.Collidable=function(a,b){this.shape=a;this._boundProperty=b;this.collides=H};jslash.behaviors.LimitedMovable=function(a,b,c){this.speed=
{x:a,y:b};this.region=c;this.move=I};window.addEventListener("load",function(){},true);jslash.net={};jslash.net.Request=function(a,b){this.src=f(a)?a:"";this.method=f(b)?b.toUpperCase():"GET";this._xhr=new XMLHttpRequest};jslash.net.Request.prototype.send=function(a,b){var c=this._xhr,d,h;if(f(b)){if(b instanceof Function)h=b;else throw Error("if second parameter is specified must be a Function");f(a)&&typeof a=="object"&&(d=a)}var g=this.src;f(d)&&this.method=="GET"&&(g+="?"+B(d));c.open(this.method,
g,true);c.onreadystatechange=function(){c.readyState==4&&h(c.responseText)};g=null;this.method=="POST"&&(c.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),g=B(d));c.send(g)}})();(function(){jslash.shapes={};jslash.shapes.Rectangle=function(d,j,h,k,m){this.x=d;this.y=j;this.width=h;this.height=k;this.color=jslash.isDefined(m)?m:new jslash.Color(0,0,0);this._filled=true};jslash.shapes.Rectangle.prototype.stroke=function(d){this._strokeSize=d;this._filled=false};jslash.shapes.Rectangle.prototype.fill=function(){this._filled=true};jslash.shapes.Rectangle.prototype.draw=function(d){this._filled?(d.fillStyle=this.color.toString(),d.fillRect(this.x,this.y,this.width,this.height)):
(d.strokeStyle=this.color.toString(),d.lineWidth=this._strokeSize,d.strokeRect(this.x,this.y,this.width,this.height))};jslash.shapes.Rectangle.prototype.toSizeable=function(){var d=this;return{width:function(){return d.width},height:function(){return d.height}}};jslash.shapes.Circle=function(d,j,h,k){this.center_x=d;this.center_y=j;this.radius=h;this.color=jslash.isDefined(k)?k:new jslash.Color(0,0,0);this._filled=true};jslash.shapes.Circle.prototype.stroke=function(d){this._strokeSize=d;this._filled=
false};jslash.shapes.Circle.prototype.fill=function(){this._filled=true};jslash.shapes.Circle.prototype.draw=function(d){d.beginPath();d.arc(this.center_x,this.center_y,this.radius,0,2*Math.PI,0);this._filled?(d.fillStyle=this.color.toString(),d.fill()):(d.strokeStyle=this.color.toString(),d.lineWidth=this._strokeSize,d.stroke());d.closePath()};jslash.shapes.Circle.prototype.toSizeable=function(){var d=this;return{width:function(){return d.width},height:function(){return d.height}}}})();
